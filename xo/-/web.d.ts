...
declare namespace $ {
    class $examples_xo_cell extends $mol_view {
        ...
        event(): {
            mouseover: (val?: any) => any;
            mouseout: (val?: any) => any;
            click: (val?: any) => any;
        };
        sub(): readonly any[];
        class(): string;
        onHover(val?: any): any;
        onHoverEnd(val?: any): any;
        onClick(val?: any): any;
        currentView(): any;
    }
}
...
declare namespace $.$$ {
    class $examples_xo_cell extends $.$examples_xo_cell {
        touched(next?: Touches): Touches;
        wincell(next?: boolean): boolean;
        currentView(): $mol_icon_close | $mol_icon_refresh | null;
        class(): "" | "wincell" | "selectable";
        hovered(next?: boolean): boolean;
        onHover(): void;
        onHoverEnd(): void;
        onClick(): void;
        onStep(cell: $examples_xo_cell): void;
    }
}
...
declare namespace $.$$ {
    class $examples_xo extends $.$examples_xo {
        ...
        auto(): void;
        newGame(): void;
        cells(next?: Array<$examples_xo_cell>): $examples_xo_cell[];
        currentStep(next?: Touches): Touches;
        onStep(cell: $examples_xo_cell): void;
        nextPlayer(): $mol_icon_close | $mol_icon_refresh;
    }
    enum Touches {
        "o" = 0,
        "x" = 1,
